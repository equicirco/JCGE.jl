...
$$
\mathrm{pz}_{i} = \mathrm{ay}_{i} \cdot \mathrm{py}_{i} + \sum_{j \in \{ \text{BRD}, \text{MLK} \} } \mathrm{ax}_{j,i} \cdot \mathrm{pq}_{j} + 0.0
$$
...
$$
Td = tau\_d \cdot \left(\sum_{h \in \{ \text{CAP}, \text{LAB} \} } \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + \sum_{i \in \{ \text{BRD}, \text{MLK} \} } \mathrm{RT}_{i} + 0.0\right)
$$
...
$$
Sp = ssp \cdot \left(\sum_{h \in \{ \text{CAP}, \text{LAB} \} } \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + \sum_{i \in \{ \text{BRD}, \text{MLK} \} } \mathrm{RT}_{i} + 0.0\right)
$$
...
$$
\mathrm{Xp}_{i} = \frac{\mathrm{alpha}_{i} \cdot \left(\sum_{h \in \{ \text{CAP}, \text{LAB} \} } \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} - Sp - Td + \sum_{j \in \{ \text{BRD}, \text{MLK} \} } \mathrm{RT}_{j} + 0.0\right)}{\mathrm{pq}_{i}}
$$
