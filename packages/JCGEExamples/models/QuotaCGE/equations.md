...
$$
\mathrm{pz}_{i} = \mathrm{ay}_{i} \cdot \mathrm{py}_{i} + \sum_{j \in \{BRD, MLK\}} \mathrm{ax}_{j,i} \cdot \mathrm{pq}_{j} + 0.0
$$
- `prod.eqpy[MLK]`
...
$$
Td = tau\_d \cdot \sum_{h \in \{CAP, LAB\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + \sum_{i \in \{BRD, MLK\}} \mathrm{RT}_{i} + 0.0
$$
- `government.eqTz[BRD]`
...
$$
\mathrm{Xg}_{i} = \frac{\mathrm{mu}_{i} \cdot Td + \sum_{j \in \{BRD, MLK\}} \mathrm{Tz}_{j} + \sum_{j \in \{BRD, MLK\}} \mathrm{Tm}_{j} + -Sg}{\mathrm{pq}_{i}}
$$
- `government.eqTz[MLK]`
...
$$
Sg = ssg \cdot Td + \sum_{i \in \{BRD, MLK\}} \mathrm{Tz}_{i} + \sum_{i \in \{BRD, MLK\}} \mathrm{Tm}_{i}
$$
- `private_saving.eqSp`

$$
Sp = ssp \cdot \sum_{h \in \{CAP, LAB\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + \sum_{i \in \{BRD, MLK\}} \mathrm{RT}_{i} + 0.0
$$
- `investment.eqXv[BRD]`
...
$$
\mathrm{Xp}_{i} = \frac{\mathrm{alpha}_{i} \cdot \sum_{h \in \{CAP, LAB\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + -Sp + -Td + \sum_{j \in \{BRD, MLK\}} \mathrm{RT}_{j} + 0.0}{\mathrm{pq}_{i}}
$$
- `household.eqXp[MLK]`
...
$$
\sum_{i \in \{BRD, MLK\}} \mathrm{pWe}_{i} \cdot \mathrm{E}_{i} + Sf = \sum_{i \in \{BRD, MLK\}} \mathrm{pWm}_{i} \cdot \mathrm{M}_{i}
$$
- `armington.eqQ[BRD]`
...
$$
\mathrm{M}_{i} = \frac{\mathrm{gamma}_{i}^{\mathrm{eta}_{i}} \cdot \mathrm{delta\_m}_{i} \cdot \mathrm{pq}_{i}}{1.0 + \mathrm{chi}_{i} + \mathrm{tau\_m}_{i} \cdot \mathrm{pm}_{i}}^{\frac{1.0}{1.0 + -\mathrm{eta}_{i}}} \cdot \mathrm{Q}_{i}
$$
- `armington.eqD[BRD]`
...
$$
\mathrm{chi}_{i} \cdot \mathrm{Mquota}_{i} + -\mathrm{M}_{i} = 0.0
$$
...
$$
\mathrm{Q}_{i} = \mathrm{Xp}_{i} + \mathrm{Xg}_{i} + \mathrm{Xv}_{i} + \sum_{j \in \{BRD, MLK\}} \mathrm{X}_{i,j}
$$
- `market.eqQ[MLK]`
