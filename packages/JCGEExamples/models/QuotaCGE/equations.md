...
$$
Td = tau\_d \cdot \left(\sum_{h \in \lbrace \text{CAP}, \text{LAB} \rbrace } \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + \sum_{i \in \lbrace \text{BRD}, \text{MLK} \rbrace } \mathrm{RT}_{i} + 0.0\right)
$$
...
$$
Sp = ssp \cdot \left(\sum_{h \in \lbrace \text{CAP}, \text{LAB} \rbrace } \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + \sum_{i \in \lbrace \text{BRD}, \text{MLK} \rbrace } \mathrm{RT}_{i} + 0.0\right)
$$
...
$$
\mathrm{Xp}_{i} = \frac{\mathrm{alpha}_{i} \cdot \left(\sum_{h \in \lbrace \text{CAP}, \text{LAB} \rbrace } \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} - Sp - Td + \sum_{j \in \lbrace \text{BRD}, \text{MLK} \rbrace } \mathrm{RT}_{j} + 0.0\right)}{\mathrm{pq}_{i}}
$$
