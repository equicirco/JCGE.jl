...
$$
\mathrm{M}_{i} = (\mathrm{gamma}_{i}^{\mathrm{eta}_{i}} \cdot \mathrm{delta\_m}_{i} \cdot \mathrm{pq}_{i} / (1 + \mathrm{chi}_{i} + \mathrm{tau\_m}_{i}) \cdot \mathrm{pm}_{i})^{(1 - \mathrm{eta}_{i})^{-1}} \cdot \mathrm{Q}_{i}
$$

`armington.eqD[BRD]`

$$
\mathrm{D}_{i} = (\mathrm{gamma}_{i}^{\mathrm{eta}_{i}} \cdot \mathrm{delta\_d}_{i} \cdot \mathrm{pq}_{i} / 1 \cdot \mathrm{pd}_{i})^{(1 - \mathrm{eta}_{i})^{-1}} \cdot \mathrm{Q}_{i}
$$
