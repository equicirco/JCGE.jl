...
$$
D_{i} = \frac{gamma_{i}^{eta_{i}} \cdot delta_d_{i} \cdot pq_{i}}{pd_scale_{i} \cdot pd_{i}}^{\frac{1.0}{1.0 + -eta_{i}}} \cdot Q_{i}
$$
- `armington.eqQ[MLK]`
...
$$
RT_{i} = \frac{1.0 + -eta_{i}}{eta_{i}} \cdot pd_{i} \cdot D_{i}
$$
- `rent.eqRT[MLK]`
