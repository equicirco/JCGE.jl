...
$$
\mathrm{pz}_{i} = \mathrm{ay}_{i} \cdot \mathrm{py}_{i} + \sum_{j \in \lbrace \text{BRD}, \text{MLK} \rbrace } \mathrm{ax}_{j,i} \cdot \mathrm{pq}_{j} + \frac{\mathrm{FC}_{i}}{\mathrm{Z}_{i}}
$$
...
$$
Td = tau\_d \cdot \left(\sum_{h \in \lbrace \text{CAP}, \text{LAB} \rbrace } \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + 0.0 + \sum_{i \in \lbrace \text{BRD}, \text{MLK} \rbrace } \mathrm{FC}_{i}\right)
$$
...
$$
Sp = ssp \cdot \left(\sum_{h \in \lbrace \text{CAP}, \text{LAB} \rbrace } \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + 0.0 + \sum_{i \in \lbrace \text{BRD}, \text{MLK} \rbrace } \mathrm{FC}_{i}\right)
$$
...
$$
\mathrm{Xp}_{i} = \frac{\mathrm{alpha}_{i} \cdot \left(\sum_{h \in \lbrace \text{CAP}, \text{LAB} \rbrace } \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} - Sp - Td + 0.0 + \sum_{j \in \lbrace \text{BRD}, \text{MLK} \rbrace } \mathrm{FC}_{j}\right)}{\mathrm{pq}_{i}}
$$
