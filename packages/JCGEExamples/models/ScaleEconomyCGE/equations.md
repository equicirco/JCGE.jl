...
$$
pz_{i} = ay_{i} \cdot py_{i} + \sum_{j \in \{BRD, MLK\}} ax_{j,i} \cdot pq_{j} + \frac{FC_{i}}{Z_{i}}
$$
- `prod.eqpy[MLK]`
...
$$
Td = tau_d \cdot \sum_{h \in \{CAP, LAB\}} pf_{h} \cdot FF_{h} + 0.0 + \sum_{i \in \{BRD, MLK\}} FC_{i}
$$
- `government.eqTz[BRD]`
...
$$
Sp = ssp \cdot \sum_{h \in \{CAP, LAB\}} pf_{h} \cdot FF_{h} + 0.0 + \sum_{i \in \{BRD, MLK\}} FC_{i}
$$
- `investment.eqXv[BRD]`
...
$$
Xp_{i} = \frac{alpha_{i} \cdot \sum_{h \in \{CAP, LAB\}} pf_{h} \cdot FF_{h} + -Sp + -Td + 0.0 + \sum_{j \in \{BRD, MLK\}} FC_{j}}{pq_{i}}
$$
- `household.eqXp[MLK]`
