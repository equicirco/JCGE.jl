...
$$
Td = tau\_d \cdot (\sum_{h \in \mathcal{D}_{h}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + 0.0 + \sum_{i \in \mathcal{D}_{i}} \mathrm{FC}_{i})
$$
...
$$
Sp = ssp \cdot (\sum_{h \in \mathcal{D}_{h}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + 0.0 + \sum_{i \in \mathcal{D}_{i}} \mathrm{FC}_{i})
$$
...
$$
\mathrm{Xp}_{i} = \frac{\mathrm{alpha}_{i} \cdot (\sum_{h \in \mathcal{D}_{h}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} - Sp - Td + 0.0 + \sum_{j \in \mathcal{D}_{j}} \mathrm{FC}_{j})}{\mathrm{pq}_{i}}
$$
