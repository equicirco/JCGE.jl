...
$$
\mathrm{pz}_{i} = \mathrm{ay}_{i} \cdot \mathrm{py}_{i} + \sum_{j \in \{BRD, MLK\}} \mathrm{ax}_{j,i} \cdot \mathrm{pq}_{j} + \frac{\mathrm{FC}_{i}}{\mathrm{Z}_{i}}
$$
- `prod.eqpy[MLK]`
...
$$
Td = tau\_d \cdot \sum_{h \in \{CAP, LAB\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + 0.0 + \sum_{i \in \{BRD, MLK\}} \mathrm{FC}_{i}
$$
- `government.eqTz[BRD]`
...
$$
Sp = ssp \cdot \sum_{h \in \{CAP, LAB\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + 0.0 + \sum_{i \in \{BRD, MLK\}} \mathrm{FC}_{i}
$$
- `investment.eqXv[BRD]`
...
$$
\mathrm{Xp}_{i} = \frac{\mathrm{alpha}_{i} \cdot \sum_{h \in \{CAP, LAB\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + -Sp + -Td + 0.0 + \sum_{j \in \{BRD, MLK\}} \mathrm{FC}_{j}}{\mathrm{pq}_{i}}
$$
- `household.eqXp[MLK]`
