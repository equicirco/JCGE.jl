...
$$
\mathrm{xd}_{i} = \mathrm{ad}_{i} \cdot \prod_{lc \in \{ \text{labor1}, \text{labor2} \} } {\mathrm{l}_{i,lc}}^{\mathrm{alphl}_{lc,i}} \cdot {\mathrm{k}_{i}}^{1.0 - \sum_{lc \in \{ \text{labor1}, \text{labor2}, \text{labor3} \} } \mathrm{alphl}_{lc,i}}
$$
...
$$
\mathrm{xd}_{i} = \mathrm{ad}_{i} \cdot \prod_{lc \in \{ \text{labor2} \} } {\mathrm{l}_{i,lc}}^{\mathrm{alphl}_{lc,i}} \cdot {\mathrm{k}_{i}}^{1.0 - \sum_{lc \in \{ \text{labor1}, \text{labor2}, \text{labor3} \} } \mathrm{alphl}_{lc,i}}
$$
...
$$
\mathrm{xd}_{i} = \mathrm{ad}_{i} \cdot \prod_{lc \in \{ \text{labor2}, \text{labor3} \} } {\mathrm{l}_{i,lc}}^{\mathrm{alphl}_{lc,i}} \cdot {\mathrm{k}_{i}}^{1.0 - \sum_{lc \in \{ \text{labor1}, \text{labor2}, \text{labor3} \} } \mathrm{alphl}_{lc,i}}
$$
...
$$
\sum_{i \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{l}_{i,lc} = \mathrm{ls}_{lc}
$$
...
$$
tariff = \sum_{i \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{tm}_{i} \cdot \mathrm{m}_{i} \cdot \mathrm{pwm}_{i} \cdot er
$$

`government_revenue.indtaxdef`

$$
indtax = \sum_{i \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{itax}_{i} \cdot \mathrm{px}_{i} \cdot \mathrm{xd}_{i}
$$

`government_revenue.netsubdef`

$$
netsub = \sum_{i \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{te}_{i} \cdot \mathrm{e}_{i} \cdot \mathrm{pwe}_{i} \cdot er
$$
...
$$
gr = \sum_{i \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{p}_{i} \cdot \mathrm{gd}_{i} + govsav
$$

`savings.depreq`

$$
deprecia = \sum_{i \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{depr}_{i} \cdot \mathrm{pk}_{i} \cdot \mathrm{k}_{i}
$$
...
$$
\mathrm{pk}_{i} \cdot \mathrm{dk}_{i} = \mathrm{kio}_{i} \cdot invest - \mathrm{kio}_{i} \cdot \sum_{j \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{dst}_{j} \cdot \mathrm{p}_{j}
$$
...
$$
\mathrm{id}_{i} = \sum_{j \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{imat}_{i,j} \cdot \mathrm{dk}_{j}
$$
...
$$
\mathrm{p}_{i} \cdot \mathrm{cd}_{i} = \sum_{hh \in \{ \text{lab-hh}, \text{cap-hh} \} } \mathrm{cles}_{i,hh} \cdot \left(1.0 - \mathrm{mps}_{hh}\right) \cdot \mathrm{yh}_{hh} \cdot \left(1.0 - \mathrm{htax}_{hh}\right)
$$
...
$$
hhsav = \sum_{hh \in \{ \text{lab-hh}, \text{cap-hh} \} } \mathrm{mps}_{hh} \cdot \mathrm{yh}_{hh} \cdot \left(1.0 - \mathrm{htax}_{hh}\right)
$$

`household_income.labory[lab-hh]`

$$
\mathrm{yh}_{\text{lab-hh}} = \sum_{lc \in \{ \text{labor1}, \text{labor2}, \text{labor3} \} } \mathrm{wa}_{lc} \cdot \mathrm{ls}_{lc} + remit \cdot er
$$

`household_income.capitaly[cap-hh]`

$$
\mathrm{yh}_{\text{cap-hh}} = \sum_{i \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{pva}_{i} \cdot \mathrm{xd}_{i} - deprecia - \sum_{lc \in \{ \text{labor1}, \text{labor2}, \text{labor3} \} } \mathrm{wa}_{lc} \cdot \mathrm{ls}_{lc} + fbor \cdot er + ypr
$$

`household_tax.hhtaxdef`

$$
tothhtax = \sum_{hh \in \{ \text{lab-hh}, \text{cap-hh} \} } \mathrm{htax}_{hh} \cdot \mathrm{yh}_{hh}
$$

`household_sum.gdp`

$$
y = \sum_{hh \in \{ \text{lab-hh}, \text{cap-hh} \} } \mathrm{yh}_{hh}
$$
...
$$
\mathrm{px}_{i} \cdot \left(1.0 - \mathrm{itax}_{i}\right) = \mathrm{pva}_{i} + \sum_{j \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{io}_{j,i} \cdot \mathrm{p}_{j}
$$

`activity_price.inteq[agricult]`

$$
\mathrm{int}_{i} = \sum_{j \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{io}_{i,j} \cdot \mathrm{xd}_{j}
$$
...
$$
\mathrm{pk}_{i} = \sum_{j \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{p}_{j} \cdot \mathrm{imat}_{j,i}
$$
...
$$
ypr = \sum_{i \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{pwm}_{i} \cdot \mathrm{m}_{i} \cdot er \cdot pr
$$

`price_index.pindexdef`

$$
pindex = \sum_{i \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{p}_{i} \cdot \mathrm{pwts}_{i}
$$

`bop.caeq`

$$
\sum_{i \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{pwm}_{i} \cdot \mathrm{M}_{i} = \sum_{i \in \{ \text{agricult}, \text{industry}, \text{services} \} } \mathrm{pwe}_{i} \cdot \mathrm{E}_{i} + fsav + remit + fbor
$$
...
$$
omega = \prod_{i \in \{ \text{agricult}, \text{industry}, \text{services} \} } {\mathrm{cd}_{i}}^{\mathrm{alpha}_{i}}
$$
