...
$$
\mathrm{Z}_{j} = \mathrm{b}_{j} \cdot \prod_{h \in \{ \text{CAP}, \text{LAB} \} } {\mathrm{F}_{h,j}}^{\mathrm{beta}_{h,j}}
$$
...
$$
\mathrm{X}_{i} = \frac{\mathrm{alpha}_{i} \cdot \sum_{h \in \{ \text{CAP}, \text{LAB} \} } \mathrm{pf}_{h} \cdot \mathrm{FF}_{h}}{\mathrm{px}_{i}}
$$
