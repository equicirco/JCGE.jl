...
$$
Td = tau\_d \cdot \left(\sum_{h \in \left\{\mathrm{CAP}, \mathrm{LAB}\right\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + 0.0 + 0.0\right)
$$
...
$$
Sp = ssp \cdot \left(\sum_{h \in \left\{\mathrm{CAP}, \mathrm{LAB}\right\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + 0.0 + 0.0\right)
$$
...
$$
\mathrm{Xp}_{i} = \frac{\mathrm{alpha}_{i} \cdot \left(\sum_{h \in \left\{\mathrm{CAP}, \mathrm{LAB}\right\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} - Sp - Td + 0.0 + 0.0\right)}{\mathrm{pq}_{i}}
$$
