...
$$
\mathrm{Y}_{i} = \mathrm{b}_{i} \cdot \prod_{h \in \lbrace \mathrm{CAP\_JPN}, \mathrm{LAB\_JPN} \rbrace} {\mathrm{F}_{h,i}}^{\mathrm{beta}_{h,i}}
$$
...
$$
\mathrm{pz}_{i} = \mathrm{ay}_{i} \cdot \mathrm{py}_{i} + \sum_{j \in \lbrace \mathrm{BRD\_JPN}, \mathrm{MLK\_JPN} \rbrace} \mathrm{ax}_{j,i} \cdot \mathrm{pq}_{j} + 0.0
$$
...
$$
\mathrm{Y}_{i} = \mathrm{b}_{i} \cdot \prod_{h \in \lbrace \mathrm{CAP\_USA}, \mathrm{LAB\_USA} \rbrace} {\mathrm{F}_{h,i}}^{\mathrm{beta}_{h,i}}
$$
...
$$
\mathrm{pz}_{i} = \mathrm{ay}_{i} \cdot \mathrm{py}_{i} + \sum_{j \in \lbrace \mathrm{BRD\_USA}, \mathrm{MLK\_USA} \rbrace} \mathrm{ax}_{j,i} \cdot \mathrm{pq}_{j} + 0.0
$$
...
$$
\sum_{j \in \lbrace \mathrm{BRD\_JPN}, \mathrm{MLK\_JPN} \rbrace} \mathrm{F}_{h,j} = \mathrm{FF}_{h}
$$
...
$$
\sum_{j \in \lbrace \mathrm{BRD\_USA}, \mathrm{MLK\_USA} \rbrace} \mathrm{F}_{h,j} = \mathrm{FF}_{h}
$$
...
$$
\mathrm{Td}_{\mathrm{JPN}} = tau\_d \cdot \sum_{h \in \lbrace \mathrm{CAP\_JPN}, \mathrm{LAB\_JPN} \rbrace} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h}
$$
...
$$
\mathrm{Xg}_{i} = \frac{\mathrm{mu}_{i} \cdot \left(\mathrm{Td}_{\mathrm{JPN}} + \sum_{j \in \lbrace \mathrm{BRD\_JPN}, \mathrm{MLK\_JPN} \rbrace} \mathrm{Tz}_{j} + \sum_{j \in \lbrace \mathrm{BRD\_JPN}, \mathrm{MLK\_JPN} \rbrace} \mathrm{Tm}_{j} - \mathrm{Sg}_{\mathrm{JPN}}\right)}{\mathrm{pq}_{i}}
$$
...
$$
\mathrm{Sg}_{\mathrm{JPN}} = ssg \cdot \left(\mathrm{Td}_{\mathrm{JPN}} + \sum_{i \in \lbrace \mathrm{BRD\_JPN}, \mathrm{MLK\_JPN} \rbrace} \mathrm{Tz}_{i} + \sum_{i \in \lbrace \mathrm{BRD\_JPN}, \mathrm{MLK\_JPN} \rbrace} \mathrm{Tm}_{i}\right)
$$

`government.eqTd[USA]`

$$
\mathrm{Td}_{\mathrm{USA}} = tau\_d \cdot \sum_{h \in \lbrace \mathrm{CAP\_USA}, \mathrm{LAB\_USA} \rbrace} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h}
$$
...
$$
\mathrm{Xg}_{i} = \frac{\mathrm{mu}_{i} \cdot \left(\mathrm{Td}_{\mathrm{USA}} + \sum_{j \in \lbrace \mathrm{BRD\_USA}, \mathrm{MLK\_USA} \rbrace} \mathrm{Tz}_{j} + \sum_{j \in \lbrace \mathrm{BRD\_USA}, \mathrm{MLK\_USA} \rbrace} \mathrm{Tm}_{j} - \mathrm{Sg}_{\mathrm{USA}}\right)}{\mathrm{pq}_{i}}
$$
...
$$
\mathrm{Sg}_{\mathrm{USA}} = ssg \cdot \left(\mathrm{Td}_{\mathrm{USA}} + \sum_{i \in \lbrace \mathrm{BRD\_USA}, \mathrm{MLK\_USA} \rbrace} \mathrm{Tz}_{i} + \sum_{i \in \lbrace \mathrm{BRD\_USA}, \mathrm{MLK\_USA} \rbrace} \mathrm{Tm}_{i}\right)
$$

`private_saving.eqSp[JPN]`

$$
\mathrm{Sp}_{\mathrm{JPN}} = ssp \cdot \sum_{h \in \lbrace \mathrm{CAP\_JPN}, \mathrm{LAB\_JPN} \rbrace} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h}
$$
...
$$
\mathrm{Sp}_{\mathrm{USA}} = ssp \cdot \sum_{h \in \lbrace \mathrm{CAP\_USA}, \mathrm{LAB\_USA} \rbrace} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h}
$$
...
$$
\mathrm{Xp}_{i} = \frac{\mathrm{alpha}_{i} \cdot \left(\sum_{h \in \lbrace \mathrm{CAP\_JPN}, \mathrm{LAB\_JPN} \rbrace} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} - \mathrm{Sp}_{r} - \mathrm{Td}_{r}\right)}{\mathrm{pq}_{i}}
$$
...
$$
\mathrm{Xp}_{i} = \frac{\mathrm{alpha}_{i} \cdot \left(\sum_{h \in \lbrace \mathrm{CAP\_USA}, \mathrm{LAB\_USA} \rbrace} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} - \mathrm{Sp}_{r} - \mathrm{Td}_{r}\right)}{\mathrm{pq}_{i}}
$$
...
$$
\sum_{i \in \lbrace \mathrm{BRD\_JPN}, \mathrm{MLK\_JPN} \rbrace} \mathrm{pWe}_{i} \cdot \mathrm{E}_{i} + Sf = \sum_{i \in \lbrace \mathrm{BRD\_JPN}, \mathrm{MLK\_JPN} \rbrace} \mathrm{pWm}_{i} \cdot \mathrm{M}_{i}
$$

`bop.eqBOP`

$$
\sum_{i \in \lbrace \mathrm{BRD\_USA}, \mathrm{MLK\_USA} \rbrace} \mathrm{pWe}_{i} \cdot \mathrm{E}_{i} + Sf = \sum_{i \in \lbrace \mathrm{BRD\_USA}, \mathrm{MLK\_USA} \rbrace} \mathrm{pWm}_{i} \cdot \mathrm{M}_{i}
$$
...
$$
\mathrm{Q}_{i} = \mathrm{Xp}_{i} + \mathrm{Xg}_{i} + \mathrm{Xv}_{i} + \sum_{j \in \lbrace \mathrm{BRD\_JPN}, \mathrm{MLK\_JPN} \rbrace} \mathrm{X}_{i,j}
$$
...
$$
\mathrm{Q}_{i} = \mathrm{Xp}_{i} + \mathrm{Xg}_{i} + \mathrm{Xv}_{i} + \sum_{j \in \lbrace \mathrm{BRD\_USA}, \mathrm{MLK\_USA} \rbrace} \mathrm{X}_{i,j}
$$
...
$$
\mathrm{UU}_{r} = \prod_{i \in \lbrace \mathrm{BRD\_JPN}, \mathrm{MLK\_JPN} \rbrace} {\mathrm{Xp}_{i}}^{\mathrm{alpha}_{i}}
$$

`utility.eqUU[USA]`

$$
\mathrm{UU}_{r} = \prod_{i \in \lbrace \mathrm{BRD\_USA}, \mathrm{MLK\_USA} \rbrace} {\mathrm{Xp}_{i}}^{\mathrm{alpha}_{i}}
$$
